...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.statix.version";
    public static final String PROP_DEVICE = "ro.statix.device";
    public static final String PROP_RELEASE_TYPE = "ro.statix.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "statix.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "statix.updater.uri";
